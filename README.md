...
[![Tests](https://img.shields.io/badge/tests-352%20passing-brightgreen)](tests/)
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-231%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-3097.14-success)](networks/build_summary.json)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **231 / 400** |
| **Local score · 本地总分** | **3097.14** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 352 passing · 352 个全部通过 |
| Networks · 网络文件 | 231 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |
