...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-216%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-2905.95-success)](networks/build_summary.json)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **216 / 400** |
| **Local score · 本地总分** | **2905.95** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 322 passing · 322 个全部通过 |
| Networks · 网络文件 | 216 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |
