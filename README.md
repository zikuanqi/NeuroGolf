...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-199%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-2690.93-success)](networks/build_summary.json)
[![Public Score](https://img.shields.io/badge/public_score-2665.68-blue)](https://www.kaggle.com/competitions/neurogolf-2026)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **199 / 400** |
| **Local score · 本地总分** | **2690.93** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
| **Public score · 公开分数 (Kaggle)** | **2665.68** — leaderboard-confirmed at 197/400 (matches local to ~0.01); tasks 198–199 submitting · 已确认 197/400（与本地一致，误差约 0.01）；198–199 提交中 |
| Solvers · 求解器 | in 9 families · 分 9 类 |
| Unit tests · 单元测试 | 282 passing · 282 个全部通过 |
| Networks · 网络文件 | 199 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |

> Local score is **2690.93 / 199 tasks**; the Kaggle leaderboard is confirmed at **2665.68 / 197** (matches local to ~0.01), with tasks 198–199 in the current submissions. The v1 → v46 progression lives in [Submission history](#history).
> 本地分数 **2690.93 / 199 解**；Kaggle 排行榜确认 **2665.68 / 197**（与本地一致，误差约 0.01），198–199 在本次提交中。v1 → v46 进展见 [提交历史](#history)。
...
| v131 | + symmetric-shape-crop (174) | 199 | _2690.93 local · submitting_ |
