...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-45%2F400-blue)](networks/)
...
| v18 | + gravity-down (size-aware per-channel column sink via content-mask height + ramp threshold) | 45 | ~698 (pending) |
