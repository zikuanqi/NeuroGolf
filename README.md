...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-221%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-2974.61-success)](networks/build_summary.json)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **221 / 400** |
| **Local score · 本地总分** | **2974.61** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 332 passing · 332 个全部通过 |
| Networks · 网络文件 | 221 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |
