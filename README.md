...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-236%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-3154.81-success)](networks/build_summary.json)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **236 / 400** |
| **Local score · 本地总分** | **3154.81** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 362 passing · 362 个全部通过 |
| Networks · 网络文件 | 236 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |
