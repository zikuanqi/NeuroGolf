...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-238%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-3176.49-success)](networks/build_summary.json)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **238 / 400** |
| **Local score · 本地总分** | **3176.49** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 366 passing · 366 个全部通过 |
| Networks · 网络文件 | 238 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |
...
| v157 | + box-interior-fill (338) | 226 | _3037.99 local · queued_ |
| v158 | + cross-tile-seed (358) | 227 | _3050.22 local · queued_ |
| v159 | + marker-to-wall (340) | 228 | _3061.74 local · queued_ |
| v160 | + symmetry-patch (351) | 229 | _3073.14 local · queued_ |
| v161 | + stamp-ref-on-blocks (368) | 230 | _3085.43 local · queued_ |
| v162 | + lattice-connect (9) | 231 | _3097.14 local · queued_ |
| v163 | + c4-complete (20) | 232 | _3108.83 local · queued_ |
| v164 | + stamp-key-on-eights (69) | 233 | _3120.58 local · queued_ |
| v165 | + mirror-repair (71) | 234 | _3130.83 local · queued_ |
| v166 | + majority-shape-crop (79) | 235 | _3142.02 local · queued_ |
| v167 | + top-marker-zigzag (82) | 236 | _3154.81 local · queued_ |
| v168 | + bar-middle-dash (85) | 237 | _3167.02 local · queued_ |
| v169 | + square-enclosure-fill (102) | 238 | _3176.49 local · queued_ |
