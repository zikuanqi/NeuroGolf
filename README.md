...
[![Local Score](https://img.shields.io/badge/local_score-2884.40-success)](networks/build_summary.json)
...
| **Local score · 本地总分** | **2884.40** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 316 passing · 316 个全部通过 |
