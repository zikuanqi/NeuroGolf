...
[![Tests](https://img.shields.io/badge/tests-252%20passing-brightgreen)](tests/)
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-184%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-2497.58-success)](networks/build_summary.json)
[![Public Score](https://img.shields.io/badge/public_score-2484.64-blue)](https://www.kaggle.com/competitions/neurogolf-2026)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **184 / 400** |
| **Local score · 本地总分** | **2497.58** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
| **Public score · 公开分数 (Kaggle)** | **2484.64** — leaderboard-confirmed at 183/400; task 184 built/verified locally, submitting · 已确认 183/400；184 已本地验证，提交中 |
| Solvers · 求解器 | in 9 families · 分 9 类 |
| Unit tests · 单元测试 | 252 passing · 252 个全部通过 |
| Networks · 网络文件 | 184 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |

> Local score is **2497.58 / 184 tasks**; the Kaggle leaderboard is confirmed at **2484.64 / 183** (exact match to local), with task 184 in the current submission. The v1 → v46 progression lives in [Submission history](#history).
> 本地分数 **2497.58 / 184 解**；Kaggle 排行榜确认 **2484.64 / 183**（与本地完全一致），184 在本次提交中。v1 → v46 进展见 [提交历史](#history)。
...
| v116 | + crop-tile-h (57) | 184 | _2497.58 local · submitting_ |
