...
[![Tests](https://img.shields.io/badge/tests-254%20passing-brightgreen)](tests/)
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-185%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-2510.04-success)](networks/build_summary.json)
[![Public Score](https://img.shields.io/badge/public_score-2497.58-blue)](https://www.kaggle.com/competitions/neurogolf-2026)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **185 / 400** |
| **Local score · 本地总分** | **2510.04** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
| **Public score · 公开分数 (Kaggle)** | **2497.58** — leaderboard-confirmed at 184/400 (exact match to local); task 185 submitting · 已确认 184/400（与本地完全一致）；185 提交中 |
| Solvers · 求解器 | in 9 families · 分 9 类 |
| Unit tests · 单元测试 | 254 passing · 254 个全部通过 |
| Networks · 网络文件 | 185 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |

> Local score is **2510.04 / 185 tasks**; the Kaggle leaderboard is confirmed at **2497.58 / 184** (exact match to local), with task 185 in the current submission. The v1 → v46 progression lives in [Submission history](#history).
> 本地分数 **2510.04 / 185 解**；Kaggle 排行榜确认 **2497.58 / 184**（与本地完全一致），185 在本次提交中。v1 → v46 进展见 [提交历史](#history)。
...
| v117 | + panel-max-fill (59) | 185 | _2510.04 local · submitting_ |
