...
[![Tasks Solved](https://img.shields.io/badge/tasks_solved-229%2F400-blue)](networks/)
[![Local Score](https://img.shields.io/badge/local_score-3073.14-success)](networks/build_summary.json)
...
| Metric · 指标 | Value · 数值 |
|---|---|
| **Tasks solved · 通过任务** | **229 / 400** |
| **Local score · 本地总分** | **3073.14** — clean-room scorer over `build_summary.json` · 独立评分器统计 |
...
| Unit tests · 单元测试 | 348 passing · 348 个全部通过 |
| Networks · 网络文件 | 229 × `networks/taskNNN.onnx` (one per solved task) · 每个解出任务一个 |
